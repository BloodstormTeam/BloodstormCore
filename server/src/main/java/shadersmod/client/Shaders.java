...
public class Shaders
{
    ...
    public static void loadShaderPack()
    {
        ...
        boolean shadersBlocked = Config.isAntialiasing();
    ...
    private static void loadShaderPackDimensions()
    {
        ...
        {
            Integer[] var2 = shaderPackDimensions.toArray(new Integer[0]);
        }
    }
    ...
    private static CustomTexture[] loadCustomTextures(Properties props, int stage)
    {
        ...
        {
            return (CustomTexture[]) list.toArray(new CustomTexture[list.size()]);
        }
    }
        ...
        else
        {
            ...
            try
            {
                ...
                if (in == null) {
                    ...
                    return new CustomTexture(index, e, tex);
                }
    ...
    public static ShaderOption[] getShaderPackOptions(String screenName)
    {
        ...
        if (shaderPackGuiScreens == null)
        {
            if (shaderPackProfiles != null)
            {
                ...
                ops = (ShaderOption[]) Config.addObjectToArray(ops, var9, 0);
            }
        ...
        else
        {
            ...
            else
            {
                ...
                ShaderOption[] var10 = (ShaderOption[]) list.toArray(new ShaderOption[list.size()]);
                return var10;
            }
        }
    }
                                        ...
                                        if (sl.isConstFloat("shadowDistanceRenderMul")) {
                                            ...
                                            if (!sl.isConstFloat("drynessHalflife") && !sl.isProperty("DRYNESSHL")) {
                                                ...
                                                else if (sl.isConstInt("superSamplingLevel"))
                                                {
                                                    ...
                                                    superSamplingLevel = Math.max(val1, 1);
                                                }
