...
public abstract class EntityLivingBase extends Entity
{
    ...
    public void onUpdate()
    {
        ...
        MinecraftTimings.timerEntityBaseTick.startTiming(); // Spigot
        super.onUpdate();
        ...
        MinecraftTimings.timerEntityBaseTick.stopTiming(); // Spigot
        this.onLivingUpdate();
        MinecraftTimings.timerEntityTickRest.startTiming(); // Spigot
        ...
        MinecraftTimings.timerEntityTickRest.stopTiming(); // Spigot
    }
    ...
    public void onLivingUpdate()
    {
        ...
        MinecraftTimings.timerEntityAI.startTiming(); // Spigot
        ...
        MinecraftTimings.timerEntityAI.stopTiming(); // Spigot
        this.worldObj.theProfiler.endSection();
        ...
        MinecraftTimings.timerEntityAIMove.startTiming(); // Spigot
        this.moveEntityWithHeading(this.moveStrafing, this.moveForward);
        MinecraftTimings.timerEntityAIMove.stopTiming(); // Spigot
        this.worldObj.theProfiler.endSection();
        this.worldObj.theProfiler.startSection("push");

        if (!this.worldObj.isRemote)
        {
            MinecraftTimings.timerEntityAICollision.startTiming(); // Spigot
            this.collideWithNearbyEntities();
            MinecraftTimings.timerEntityAICollision.stopTiming(); // Spigot
        }
