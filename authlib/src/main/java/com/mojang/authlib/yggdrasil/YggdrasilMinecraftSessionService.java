...
public class YggdrasilMinecraftSessionService extends HttpMinecraftSessionService {
    ...
    protected YggdrasilMinecraftSessionService(final YggdrasilAuthenticationService authenticationService) {
        ...
        try {
            final X509EncodedKeySpec spec = new X509EncodedKeySpec(IOUtils.toByteArray(Objects.requireNonNull(YggdrasilMinecraftSessionService.class.getResourceAsStream("/yggdrasil_session_pubkey.der"))));
